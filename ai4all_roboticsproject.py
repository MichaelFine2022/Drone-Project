# -*- coding: utf-8 -*-
"""AI4ALL_RoboticsProject.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Czk1h8NGIOAT8qyk3E2f7fv41Xcq7gti
...
#@title
# RobotData class to store the poses of the robots
class RobotData:
...
class Coverage:
  ...
  # Maintainer: Maria Santos
  # Converted to Python by Ken Nakamura
...
def NLC(CovCont):
  ...
  for iter in range(CovCont.nIter):
    ...
    while error_cm > CovCont.tol:
      ...
      ''' TODO '''
      # Define the error for the convergence task
      # try np.linalg.norm!
